...
@section('content')
    ...
    <style>
        ...
        .table-nilai thead th:nth-child(2) {
            text-align: left;
        }
        ...
        .table-nilai tbody td:first-child {
            width: 60px;
        }

        .table-nilai tbody td:nth-child(2) {
            text-align: left;
            width: 45%;
        }
    ...
    <div class="container py-4">
        ...
        <div class="form-card">
            <div class="card-body">
                ...
                <div id="alertSemester" class="alert alert-danger mb-3" style="display:none;">
                    <i class="fa-solid fa-circle-exclamation me-1"></i>
                    Nilai mahasiswa untuk semester ini sudah pernah diinput.
                </div>
                @if ($errors->any())
                    <div class="alert alert-danger"
                        style="background:#fef2f2; color:#991b1b; border:1px solid #fecaca; border-radius:10px; padding:0.6rem 1rem; font-size:0.85rem;">
                        <ul class="mb-0 ps-3">
                ...
                <div id="alertKosong" class="alert alert-danger mb-3" style="display:none;">
                    <i class="fa-solid fa-circle-exclamation me-1"></i>
                    Semua field nilai harus diisi terlebih dahulu.
                </div>
                <form action="{{ route('nilai.store') }}" method="POST" id="formNilai">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" id="searchMahasiswa" class="form-control"
                                placeholder="Ketik NIM atau Nama" autocomplete="off">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadMatkul() {
                ...
                if (!semester || !nim) {
                    ...
                    document.getElementById('alertSemester').style.display = 'none';
                    return;
                }

                // Cek dulu apakah sudah pernah input
                fetch(`/api/check-nilai?nim=${nim}&semester=${semester}`)
                    .then(res => res.json())
                    .then(result => {

                        if (result.exists) {

                            document.getElementById('alertSemester').style.display = 'block';
                        ...
                        <tr>
                            ...
                            <td>
    <input type="number"
        name="nilai[${matkul.id}][kehadiran]"
        min="0"
        max="100"
        step="1"
        placeholder="0-100"
...
<td>
    <input type="number"
        ...
        const alertKosong = document.getElementById('alertKosong');
        ...
        formNilai.addEventListener('submit', function(e) {
            ...
            const inputs = matkulBody.querySelectorAll('input[type="number"]');
