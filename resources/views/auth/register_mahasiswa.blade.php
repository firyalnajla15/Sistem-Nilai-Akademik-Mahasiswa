...
<head>
    ...
    <title>Register Mahasiswa - Sistem Nilai Akademik</title>
    ...
    <div class="container register-container">
        <div class="register-card">
            ...
            <div class="text-center mb-3">
                ...
                <h4 class="register-title">Aktivasi Akun</h4>
                <p class="register-subtitle">Lengkapi data untuk login Portal Mahasiswa</p>
            </div>
            ...
            <form action="{{ url('/mahasiswa/register') }}" method="POST">
                ...
                <div class="mb-2">
                    <label class="form-label">NIM Resmi</label>
                    <input type="text" name="nim" class="form-control" placeholder="Contoh: 2401092007"
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-custom-dark">
                        <i class="fa-solid fa-user-plus"></i> Aktivasi Akun
                    </button>
                </div>
            </form>
            ...
            <div class="text-center small mt-3">
                ...
                <a href="{{ route('mahasiswa.login') }}" class="register-link">Login</a>
            </div>
