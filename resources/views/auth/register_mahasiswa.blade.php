    ...
    <div class="container register-container">
        <div class="register-card">
            ...
            <div class="text-center mb-3">
                <h4 class="fw-bold m-0" style="color: #1a252f;">Aktivasi Akun</h4>
                <p class="text-muted small m-0">Lengkapi data login Portal Mahasiswa</p>
            </div>
            ...
            <div class="text-center small mt-3">
                ...
                <a href="{{ route('mahasiswa.login') }}" class="text-decoration-none fw-semibold"
                    style="color: #1a252f;">Login</a>
            </div>
